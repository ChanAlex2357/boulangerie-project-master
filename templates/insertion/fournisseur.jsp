...
<html lang="en">
    <head>
        <!-- Title -->
        <title> Insertion Fournisseur</title>
        <meta charset="utf-8">
            ...
            <div class="content">
                <div class="py-4 px-3 px-md-4">
                    <div class="mb-3 mb-md-4 d-flex justify-content-between">
                        <div class="h3 mb-0">Insertion fournisseur</div>
                    </div>
                </div> 
                <div class="card-body">
                    <div class="row">
                        <form method="POST" action="/boulangerie/CrudFournisseur" class="offset-2 col-8">
                            <div class="form-group">
                                <label for="simpleinput">Nom</label>
                                <input type="text" id="simpleinput" name="nom" placeholder="entrer le nom de la fournisseur" class="form-control">
                            </div>
