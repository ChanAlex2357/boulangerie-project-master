...
public class Main {
    public static void main(String[] args) {
        try (Connection conn = Utilitaire.getConn()) {
            ...
            generateProductTypeData(conn);
            generateProductData(conn);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public static void generateProductTypeData(Connection conn) throws Exception {
    ...
    public static void generateProductData(Connection conn) throws Exception {
